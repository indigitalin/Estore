                        ...
                        <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                            <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                                ...
                                <form wire:submit="login">
                                    ...
                                    <div class="mb-6">
                                        <x-input-label class="mb-2.5 block font-medium text-black dark:text-white" for="email" :value="__('Email')" />
                                        <div class="relative">
                                    ...
                                    <div class="mb-6">
                                        <x-input-label class="mb-2.5 block font-medium text-black dark:text-white" for="password" :value="__('Password')" />
                                        <div class="relative">
                                            <x-text-input placeholder="Enter your password"
                                    ...
                                    <div class="mb-5">
                                        <x-primary-button class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90">
                                            {{ __('Sign In') }}
                                        </x-primary-button>
                                    </div>
