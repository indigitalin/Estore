                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                            <div class="flex items-center gap-3">
                                <div class="flex-shrink-0 ">
                                    <img src="{{ $product->thumbnail_image_url }}" class="rounded-full w-12 h-12 object-cover rounded-full"
                                        alt="Brand" />
                                </div>
                                <div class="">
                        ...
                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <p role="button"
                                @click="actionConfirmed({{ $product->id }}, 'status')"
                        ...
                        <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark text-end">
                            <div class="flex items-center">
                                <x-action-button x-data="{ tooltip: 'Edit product' }" x-tooltip="tooltip" role="button" class="ms-auto me-2"
                                    wire:navigate href="{{ route('client.products.edit', $product) }}">
