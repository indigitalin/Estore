<div x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
    ...
    <div class="bg-white rounded-lg shadow-lg max-w-6xl w-full z-50 relative">
        <input id="images" wire:model="images" wire:ignore class="absolute w-full h-full top-0 start-0 opacity-0"
            multiple type="file" accept="image/jpeg, image/png, image/webp, image/jpg" />
        <div @click.stop="" class="p-6 z-50 relative">
